...
export function AppProvider({ children }) {
  ...
  const [workerWalletBalance, setWorkerWalletBalance] = useState(null);
  ...
  const publicKey = "FLWPUBK-dcb2c3d7a40710253a632b3d6e20468e-X";
  ...
  const fetchWorkerBalance = async () => {
    ...
    try {
      ...
      setWorkerWalletBalance(data.WalletBalance);
    } catch (error) {
