...
export default function TaskDetailsPage() {
  ...
  //   const submitted = new Date(submittedAt).getTime(); // always UTC
  //   const now = new Date().getTime(); // always UTC internally
  //   const diffMs = now - submitted;

  //   console.log(submitted, now, diffMs);
  ...
  function timeAgo(submittedAt) {
    ...
    console.log(seconds, minutes, hours, diffMs);
